        ...
        $.ajax({
          ...
          complete: function(data){
            ...
            for (i in fileNames) {
              ...
              $("#list-style").append("<a class=\"list-group-item list-group-item-action ctstyle itemlist\" id=\"test-list-home-list\" data-toggle=\"list\" href=\"#test-list-home\" role=\"tab\" aria-controls=\"home\" onclick=\"javascript:pick_style()\"><div style=\"padding-left: 20px\">"+fileNames[i].filename+"<div>"+fileNames[i].contents+"</div></div></a>")
            }
          }
        });
